...
<template id="coopleo-result-simplified-tpl">
    <a href="#" class="result-card-simplified" <?php echo ($vars['openNewTab'] ? 'target="_blank"': '') ?> data-target-tpl="button-link">
        <div class="result-card-therapist-infos">
            <img src="<?php echo COOPLEO_PLUGIN_URL . 'assets/icons/therapist-no-picture.png'; ?>" alt="Photo de profil">
            <div>
                <h2 class="result-card-therapist-name" data-target-tpl="name"></h2>
                <h3 class="result-card-therapist-type" data-target-tpl="type"></h3>
                <div class="result-card-therapist-detail result-card-therapist-address">
...
<script type="module">
    ...
    const resultSimplifiedTpl = document.querySelector("#coopleo-result-simplified-tpl");
    ...
    function generateSimplifiedResult(data){
        const result = resultSimplifiedTpl.content.cloneNode(true);
